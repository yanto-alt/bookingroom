...
import { Car, Info, Hash, Users, Activity, User, ArrowLeft } from "lucide-react";
    ...
    async function onSubmit(event) {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error(json.message || `Gagal ${isEdit ? 'mengupdate' : 'membuat'} kendaraan`);
            }
        ...
        <div className="max-w-2xl mx-auto space-y-6 fade-in">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-600">
                        {isEdit ? `Perbarui data ${vehicle.name}` : "Masukkan data kendaraan baru"}
                    </p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
                <form onSubmit={onSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                name="type"
                                required
                                defaultValue={vehicle?.type || "Minibus"}
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-700 flex items-center gap-2">
                            <User size={16} /> Nama Driver (Opsional)
                        </label>
                        <input
                            type="text"
                            name="driverName"
